    ...
    <div className={styles.guardrailOverlay}>
      <div className={styles.gateModal}>
        ...
        <p className={styles.gateMessage}>
          Swaraj Chakravyuh needs at least one LLM provider (DeepSeek, Anthropic, OpenAI, ...) before
  ...
  return (
    <div className={styles.guardrailOverlay}>
      <div className={styles.gateModalWide}>
        ...
        <p className={styles.gateMessage}>
          Choose the models Swaraj Chakravyuh will use for this project. We&apos;ll remember them as the
