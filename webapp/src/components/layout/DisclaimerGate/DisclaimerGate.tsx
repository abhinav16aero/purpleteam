    ...
    return (
      <div className={styles.overlay}>
        <div className={styles.card}>
          <Image src="/logo.svg" alt="" aria-hidden width={520} height={520} className={styles.eyeBg} />
          <div className={styles.welcomeHeader}>
            <Image src="/logo.svg" alt="Swaraj Chakravyuh" width={36} height={36} style={{ objectFit: 'contain' }} />
          ...
          <div className={styles.body}>
            <p className={styles.welcomeThank}>
              Thank you for downloading and installing <strong>Swaraj Chakravyuh</strong>!
            </p>

            <p className={styles.welcomeDesc}>
              <strong>Swaraj Chakravyuh</strong> is an open-source, AI-powered
            ...
            <div className={styles.missionBox}>
              <p className={styles.missionText}>
                Our commitment is to keep Swaraj Chakravyuh always up-to-date and make it
            ...
            >
              ...
              <span>Star Swaraj Chakravyuh on GitHub</span>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.body}>
          <p className={styles.intro}>
            <strong>Swaraj Chakravyuh</strong> is an AI-powered penetration testing
