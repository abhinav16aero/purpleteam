...
export function buildTemplate(
  ...
  return {
    _instructions: 'Fill in your API keys below. Leave empty strings for keys you don\'t use. For key rotation, add multiple keys to the array. Upload this file back to Swaraj Chakravyuh at Settings > API Keys & Tunneling.',
    keys,
    rotation,
    tunneling,
  }
