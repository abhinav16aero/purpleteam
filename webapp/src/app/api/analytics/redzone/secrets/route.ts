...
export async function GET(request: NextRequest) {
  ...
  try {
    // Secrets in Swaraj Chakravyuh always live in the :Secret node. They can be attached via
    ...
    // Priority weighting. `secret_type` in Swaraj Chakravyuh is the pattern-family name
