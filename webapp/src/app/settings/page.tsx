    ...
    <div className={styles.page}>
      ...
      {activeTab === 'providers' && <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            ...
            <WikiInfoButton target="#" title="Open AI Model Providers wiki page" />
          </h2>
      ...
      {activeTab === 'skills' && <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            ...
            <WikiInfoButton target="#" title="Open Agent Skills wiki page" />
          </h2>
        ...
        <p className={styles.sectionHint}>
          ...
          {' '}Browse <a href="#" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-primary)', textDecoration: 'underline' }}>community skills</a> for ready-to-use templates.
        </p>
      ...
      {activeTab === 'chat-skills' && <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            ...
            <WikiInfoButton target="#" title="Open Chat Skills wiki page" />
          </h2>
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <button
              className="secondaryButton"
      ...
      {activeTab === 'tradecraft' && <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            ...
            <WikiInfoButton target="#" title="Open Tradecraft Lookup wiki page" />
          </h2>
      ...
      <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            <span>Tunneling</span>
            <WikiInfoButton target="#" title="Open Reverse Shells wiki page" />
          </h2>
        </div>
        <p className={styles.sectionHint}>
  ...
  return (
    <div className={styles.section}>
      <div className={styles.sectionHeader}>
        <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
          <Info size={16} /> System
          <WikiInfoButton target="#" title="Open Troubleshooting wiki page" />
        </h2>
      </div>
